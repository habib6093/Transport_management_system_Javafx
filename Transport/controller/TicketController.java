...
public class TicketController {
	...
	/*
	checks for filled tickets in schedule and updates seats accordingly 
	...
	*/  
	...
	public void Routing (ActionEvent e) throws Exception {
		...
		if(e.getSource() == routes){
			checker = 1;
			tele.changeTo(routes, "route.fxml");
